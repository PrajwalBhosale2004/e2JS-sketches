...
#include <pcap/pcap.h>
#include <getopt.h>
#include "twofa_sketch_common.h"
#include "twofa_sketch_ebpf.skel.h"
...
int main(int argc, char** argv) {
    ...
    struct twofa_sketch_ebpf* skel = twofa_sketch_ebpf__open_and_load();
    if (!skel) {
    ...
    if (!ifindex) {
        ...
        twofa_sketch_ebpf__destroy(skel);
        HashMap_destroy(ground_truth);
        return 1;
    }

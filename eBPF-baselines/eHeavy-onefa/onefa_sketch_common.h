#ifndef __ONEFA_SKETCH_COMMON_H
#define __ONEFA_SKETCH_COMMON_H

#ifndef SKETCH_MEMORY
#define SKETCH_MEMORY 1024  
#endif

#define COUNTER_PER_BUCKET 8
#define MAX_VALID_COUNTER 7  
#define KEY_LEN 13
#define MAX_BUCKETS ((SKETCH_MEMORY * 1024) / (8 * COUNTER_PER_BUCKET))
...
struct Elastic_1FASketch_Heavypart {
    struct Bucket buckets[MAX_BUCKETS];
    __u32 bucket_num;
    __u32 cnt_all;   
};

struct Elastic_1FASketch {
